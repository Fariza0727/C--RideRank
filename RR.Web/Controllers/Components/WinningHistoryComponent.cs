...
{
     [ViewComponent(Name = "WinningHistoryComponent")]
     public class WinningHistoryComponent : ViewComponent
     {
          ...
          public WinningHistoryComponent(
          ...
          //public async Task<IActionResult> OnPost(UserDetailDto detailDto, IFormCollection form)
          //{
